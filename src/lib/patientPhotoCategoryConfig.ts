...
export const PATIENT_UPLOAD_CATEGORY_DEFS = [
  ...
  /* ----- HA-DUAL-PATHWAY-2: pathway-specific evidence slots ----- */

  {
    key: "preop_wet_top",
    label: "Wet Hair — Top View",
    description: "Top view with damp hair helps us see scalp coverage and part-line density more clearly.",
    phase: "preoperative",
    region: "vertex",
    purpose: "Wet-hair density signal for planning.",
    required: false,
    visibleInUi: false,
    tips: ["Damp hair, not dripping", "Same overhead angle as your dry top photo"],
    accept: "image/*",
    maxFiles: 3,
    minFiles: 0,
    mapsToAuditEvidenceKey: "patient_current_top",
  ...
  {
    key: "preop_hairline_closeup",
    label: "Hairline Close-up",
    description: "A closer front photo of your hairline helps us assess design options and recession pattern.",
    phase: "preoperative",
    region: "front",
    purpose: "Hairline detail for candidacy review.",
    required: false,
    visibleInUi: false,
    tips: ["Hold camera 20–30 cm away", "Even lighting across the hairline"],
    accept: "image/*",
    maxFiles: 3,
    minFiles: 0,
    mapsToAuditEvidenceKey: "patient_current_front",
  ...
  {
    key: "preop_clinic_quote",
    label: "Clinic Quote or Plan (Optional)",
    description: "A quote or treatment plan from a clinic helps us compare proposed graft counts with your photos.",
    phase: "preoperative",
    region: "supplemental",
    purpose: "Planning context from clinic documentation.",
    required: false,
    visibleInUi: false,
    tips: ["PDF or clear photo of the document", "Hide personal details you do not want stored"],
    accept: ".pdf,image/*,application/pdf",
    maxFiles: 2,
    minFiles: 0,
  },
  {
    key: "preop_styling_reference",
    label: "Current Hair Length / Styling Reference",
    description: "Shows how you usually wear your hair — useful when judging coverage and styling expectations.",
    phase: "preoperative",
    region: "supplemental",
    purpose: "Styling context for realistic planning.",
    required: false,
    visibleInUi: false,
    tips: ["Everyday styling, not salon setup", "Front and side if possible"],
    accept: "image/*",
    maxFiles: 4,
    minFiles: 0,
  },
  {
    key: "preop_family_pattern",
    label: "Family Hair Loss Pattern (If Relevant)",
    description: "A photo showing family hair loss patterns can help us discuss long-term progression risk.",
    phase: "preoperative",
    region: "supplemental",
    purpose: "Hereditary progression context.",
    required: false,
    visibleInUi: false,
    tips: ["Parent or sibling hairline photo if available", "Only if you are comfortable sharing"],
    accept: "image/*",
    maxFiles: 3,
    minFiles: 0,
  },
  {
    key: "current_recipient_closeup",
    label: "Recipient Area Close-up",
    description: "A close photo of the transplanted zone shows graft direction, density, and any gaps.",
    phase: "follow_up",
    region: "recipient_healing",
    purpose: "Recipient-zone detail for audit review.",
    required: false,
    visibleInUi: false,
    tips: ["Good light on the hairline or mid-scalp", "Hold camera steady, no filters"],
    accept: "image/*",
    maxFiles: 4,
    minFiles: 0,
    mapsToAuditEvidenceKey: "patient_current_front",
  ...
  {
    key: "postop_wet_recipient",
    label: "Wet Hair — Recipient View",
    description: "Damp hair over the recipient area reveals scalp show-through and density more clearly.",
    phase: "follow_up",
    region: "recipient_healing",
    purpose: "Wet-hair density assessment post-op.",
    required: false,
    visibleInUi: false,
    tips: ["Same angle as your dry front photo", "Damp, not dripping"],
    accept: "image/*",
    maxFiles: 3,
    minFiles: 0,
  },
...

  {
    ...
    label: "Donor area — left view",
    description: "Left lateral donor and posterior scalp. Helps document side-to-side healing balance.",
    phase: "preoperative",
    region: "donor_left",
    purpose: "Donor zone baseline and symmetry for monitoring.",
    required: false,
    visibleInUi: true,
    tips: ["Include full left donor transition", "Even lighting", "Dry hair, no fibres"],
    accept: "image/*",
    maxFiles: 4,
    minFiles: 0,
  },
  {
    ...
    label: "Donor area — right view",
    description: "Right lateral donor and posterior scalp. Helps document side-to-side healing balance.",
    phase: "preoperative",
    region: "donor_right",
    purpose: "Donor zone baseline and symmetry for monitoring.",
    required: false,
    visibleInUi: true,
    tips: ["Include full right donor transition", "Even lighting", "Dry hair, no fibres"],
    accept: "image/*",
    maxFiles: 4,
    minFiles: 0,
  },
