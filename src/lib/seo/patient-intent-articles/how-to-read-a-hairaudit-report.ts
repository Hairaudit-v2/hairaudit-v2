  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "[Request an independent HairAudit review](/request-review). [sample HairAudit report](/demo-report). [What an Independent Hair Transplant Audit Can and Cannot Do](/what-an-independent-hair-transplant-audit-can-and-cannot-do). [FAQ](/faq).",
        },
      ],
    },
  ],
