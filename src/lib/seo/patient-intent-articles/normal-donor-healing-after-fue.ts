...
export const normalDonorHealingAfterFueArticle: PatientIntentArticle = {
  ...
  faqs: [],
  ctaLead: "Unsure whether your donor pattern looks like normal healing?",
  ctaSupporting: "Request an independent HairAudit review of your donor documentation and timeline.",
  relatedSlugs: [
