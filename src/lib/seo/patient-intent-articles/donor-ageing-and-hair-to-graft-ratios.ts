  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "[Can a hair transplant be audited from photos](/can-a-hair-transplant-be-audited-from-photos), [Request an independent HairAudit review](/request-review), [sample HairAudit report](/demo-report).",
        },
      ],
    },
  ],
