...
export const DOCTOR_PHOTO_SCHEMA: PhotoCategoryDef[] = [
  { key: "preop_front", title: "Pre-op — Front", min: 1, max: 3, required: true },
  { key: "preop_left", title: "Pre-op — Left", min: 1, max: 2, required: true },
  { key: "preop_right", title: "Pre-op — Right", min: 1, max: 2, required: true },
  { key: "preop_top", title: "Pre-op — Top", min: 1, max: 3, required: true },
  { key: "preop_crown", title: "Pre-op — Crown", min: 1, max: 3, required: true },
  { key: "preop_donor_rear", title: "Pre-op — Donor (rear)", min: 1, max: 5, required: true },
  { key: "day0_recipient", title: "Day-of surgery — Recipient", min: 1, max: 6, required: true },
  { key: "day0_donor", title: "Day-of surgery — Donor", min: 1, max: 6, required: true },
  { key: "intraop", title: "Intra-op (Optional)", min: 0, max: 6, required: false },
  { key: "postop_day0_3", title: "Post-op Day 0–3 (Optional)", min: 0, max: 6, required: false },
];
