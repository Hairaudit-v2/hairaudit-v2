...
import DonorCapacityPlanSection from "@/components/patient/DonorCapacityPlanSection";
...
export default function PostSurgeryAuditReportShell({
  ...
  return (
    <section data-testid="post-surgery-report-shell" className="mt-6 space-y-5">
      ...
      {report.donorCapacityPlan ? (
        <DonorCapacityPlanSection plan={report.donorCapacityPlan} />
      ) : null}
      ...
      <FutureHairLossRiskSection pathway="post_surgery" result={report.futureHairLossRisk} />
