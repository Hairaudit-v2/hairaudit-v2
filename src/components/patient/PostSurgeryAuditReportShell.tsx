...
export default function PostSurgeryAuditReportShell({
  ...
  return (
    <section className="mt-6 space-y-5">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        <h3 className="text-lg font-semibold text-slate-900">
          {t("dashboard.patient.postSurgeryReport.images.title")}
        </h3>
            ...
            >
              {img.imageUrl ? (
                ...
                <div className="flex aspect-[4/3] items-center justify-center bg-slate-100 text-sm text-slate-500">
                  {t("dashboard.patient.postSurgeryReport.images.noPhoto")}
                </div>
              )}
              <div className="p-4">
                <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">
                  {t(
                    `dashboard.patient.postSurgeryReport.images.views.${img.viewKey}` as TranslationKey
                  )}
                </p>
