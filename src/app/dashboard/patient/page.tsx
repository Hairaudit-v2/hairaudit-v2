    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
          ...
          <p className="text-slate-600 text-sm mt-1">Get feedback on your hair transplant surgery</p>
        </div>
      </div>

      <div className="rounded-xl border border-amber-200 bg-amber-50/80 p-4 mb-6">
        <p className="text-sm text-amber-900">
          Upload your photos and answer a short questionnaire about your procedure. We&apos;ll provide an AI-powered audit and feedback on your results.
        </p>
      </div>
      ...
      <h2 className="text-lg font-semibold text-slate-900 mt-8 mb-3">My audit requests</h2>
      {(!cases || cases.length === 0) ? (
        <div className="rounded-xl border border-slate-200 bg-white p-8 text-center">
          <p className="text-slate-600 mb-4">No cases yet. Create your first one to get feedback on your surgery.</p>
          <CreateCaseButton />
        </div>
      ) : (
