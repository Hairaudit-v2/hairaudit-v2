            ...
            <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {HOW_IT_WORKS_STEPS.map((step, index) => (
                <ScrollReveal key={step.title} delay={0.03 + index * 0.02}>
                  <div className="rounded-2xl border border-white/10 bg-slate-900/50 p-6 flex flex-col items-center text-center">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              {CERTIFICATION_TIERS.map(({ tier, blurb }) => (
                <ScrollReveal key={tier} delay={0.02}>
                  <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 min-w-[200px] max-w-[240px]">
