      ...
      <main id="main-content" className="flex-1 px-4 py-16 sm:py-20">
        <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert max-w-none prose-headings:text-foreground prose-p:text-muted-foreground">
          ...
          <section>
            ...
            <p>
              HairAudit provides independent, evidence-based review of hair transplant
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8">3. Account and Registration</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8">4. User Obligations</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8">5. No Medical Advice</h2>
            <p>
              Our Clinical Intelligence Reports and review outputs are for informational purposes only. They do not constitute medical
              advice, diagnosis, or treatment. HairAudit supports informed discussion with clinicians but does not replace
              consultation with a qualified healthcare provider. You should consult a licensed medical professional for
          ...
          <section>
            ...
            <p>
              ...
              our prior written consent. Reports generated for you remain your property for
