    ...
    >
      <div className="space-y-6 text-muted-foreground">
        <section className="rounded-2xl border border-border/50 bg-card/70 shadow-fi-panel p-6">
          <h2 className="text-xl font-semibold text-foreground">Structured review model</h2>
          <p className="mt-3">
        ...
        <section className="rounded-2xl border border-border/50 bg-card/70 shadow-fi-panel p-6">
          <h2 className="text-xl font-semibold text-foreground">Assessment principles</h2>
        ...
        <section className="rounded-2xl border border-border/50 bg-card/70 shadow-fi-panel p-6">
          <h2 className="text-xl font-semibold text-foreground">AI-assisted, expert-reviewed</h2>
          <p className="mt-3">
