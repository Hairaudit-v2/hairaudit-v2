    ...
    >
      <div className="space-y-6 text-muted-foreground">
        <section className="rounded-2xl border border-border/50 bg-card/70 shadow-fi-panel p-6">
          <h2 className="text-xl font-semibold text-foreground">Required image types</h2>
        ...
        <section className="rounded-2xl border border-border/50 bg-card/70 shadow-fi-panel p-6">
          <h2 className="text-xl font-semibold text-foreground">Evidence sufficiency and confidence grading</h2>
          <p className="mt-3">
        ...
        <section className="rounded-2xl border border-border/50 bg-card/70 shadow-fi-panel p-6">
          <h2 className="text-xl font-semibold text-foreground">Image-only limitations</h2>
          <p className="mt-3">
