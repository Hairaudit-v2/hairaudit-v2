        ...
        <div className="max-w-3xl mx-auto prose prose-neutral dark:prose-invert max-w-none prose-headings:text-foreground prose-p:text-muted-foreground">
          ...
          <section className="mt-8">
            ...
            <p>
              ...
              independent, evidence-based review services for hair restoration cases. This Privacy Policy explains how we collect,
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              ...
              <li>
                <strong>Case submissions:</strong> Photos, procedure details, answers to review
                questions, and any other information you submit for independent analysis
              </li>
              <li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-1 text-muted-foreground">
              <li>Provide review services and generate Clinical Intelligence Reports</li>
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8">4. Confidentiality</h2>
            <p>
              All case submissions are handled confidentially. We do not share your personal
              information, photos, or report outputs with third parties without your express consent,
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground mt-8">9. Changes</h2>
            <p>
